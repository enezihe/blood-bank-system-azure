        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="panel panel-default panel-info" style="border-radius:50px;">
              <div class="panel-body panel-info text-center" style="background-color:#D6EAF8; border-radius:50px;">
                <?php
          ...
          <div class="col-md-3">
            <div class="panel panel-default panel-info" style="border-radius:50px;">
              <div class="panel-body panel-info text-center" style="background-color:#ABEBC6; border-radius:50px;">
                <?php
          ...
          <div class="col-md-3">
            <div class="panel panel-default panel-info" style="border-radius:50px;">
              <div class="panel-body panel-info text-center" style="background-color:#E8DAEF; border-radius:50px;">
                <?php
...
<?php else: ?>
  <div class="container">
    <div class="alert alert-danger mt-5"><b>Please login first to access the Admin Portal.</b></div>
